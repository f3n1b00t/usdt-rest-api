...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Get allowance request")
public class GetAllowanceRequest {
    ...
    @Pattern(message = "spender is invalid", regexp = "^0x[a-fA-F0-9]{40}$")
    @Schema(name = "spender", description = "The address of the spender", example = "0x0000000000000000000000000000000000000000")
